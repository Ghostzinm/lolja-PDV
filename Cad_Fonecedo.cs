...
namespace LOLja
{
    public partial class Cad_Fonecedo : Form
    {
        public Cad_Fonecedo()
        {
            InitializeComponent();
        ...
        private void Cad_Cliente_Load(object sender, EventArgs e)
        {
            ...
            textBoxCNPJ.Text = "Digite seu CNPJ";
            ...
            textBoxCNPJ.ForeColor = Color.Gray;
            ...
            textBoxCNPJ.Enter += (s, ev) =>
            {
                if (textBoxCNPJ.Text == "Digite seu CNPJ")
                {
                    textBoxCNPJ.Text = "";
                    textBoxCNPJ.ForeColor = Color.Black;
                }
            };
            textBoxCNPJ.Leave += (s, ev) =>
            {
            ...
            else
            {
                ...
                using (MySqlConnection conexao = new MySqlConnection(conexaoBanco))
                {
                    ...
                    try
                    {
                        ...
                        {
                            string query = "INSERT INTO tb_Clientes (email, nome, senha, telefone, CNPJ) VALUES (@Email, @Nome, @Senha, @telefone, @cnpj)";
